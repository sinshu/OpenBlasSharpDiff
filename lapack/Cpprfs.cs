...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="afp">
        /// [in] AFP is COMPLEX array, dimension (N*(N+1)/2).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_cpprfs", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Cpprfs(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="a">
        /// [in] A is REAL array, dimension ( N*(N+1)/2 ).
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_spftrs", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Spftrs(

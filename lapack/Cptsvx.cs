...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="ef">
        /// [in,out] EF is COMPLEX array, dimension (N-1).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_cptsvx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Cptsvx(

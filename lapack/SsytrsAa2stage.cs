...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="tb">
        /// [out] TB is REAL array, dimension (LTB).
        /// Details of factors computed by SSYTRF_AA_2STAGE.
        /// </param>
        /// <param name="ltb">
        /// [in] LTB is INTEGER.
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_ssytrs_aa_2stage", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo SsytrsAa2stage(

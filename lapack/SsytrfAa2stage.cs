...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_ssytrf_aa_2stage", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo SsytrfAa2stage(

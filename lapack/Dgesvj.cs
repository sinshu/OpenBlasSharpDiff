...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="v">
        /// [in,out] V is DOUBLE PRECISION array, dimension (LDV,N).
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dgesvj", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dgesvj(

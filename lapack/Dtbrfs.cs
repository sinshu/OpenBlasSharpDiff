...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="x">
        /// [in] X is DOUBLE PRECISION array, dimension (LDX,NRHS).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dtbrfs", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dtbrfs(

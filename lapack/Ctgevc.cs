...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="s">
        /// [in] S is COMPLEX array, dimension (LDS,N).
        ...
        /// </param>
        /// <param name="p">
        /// [in] P is COMPLEX array, dimension (LDP,N).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_ctgevc", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Ctgevc(

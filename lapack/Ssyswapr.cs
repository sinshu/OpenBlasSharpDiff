...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="a">
        /// [in,out] A is REAL array, dimension (LDA,*).
        ...
        /// </param>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_ssyswapr", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Ssyswapr(

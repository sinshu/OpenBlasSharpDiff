...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="z">
        /// [out] Z is DOUBLE PRECISION array, dimension (LDZ, M).
        ...
        /// array IFAIL.
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dstein", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dstein(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="afp">
        /// [in,out] AFP is DOUBLE PRECISION array, dimension (N*(N+1)/2).
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dspsvx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dspsvx(

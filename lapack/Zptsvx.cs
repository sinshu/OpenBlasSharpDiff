...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="ef">
        /// [in,out] EF is COMPLEX*16 array, dimension (N-1).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_zptsvx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Zptsvx(

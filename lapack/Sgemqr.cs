...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="a">
        /// [in] A is REAL array, dimension (LDA,K).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_sgemqr", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Sgemqr(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="ef">
        /// [in] EF is REAL array, dimension (N-1).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_sptrfs", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Sptrfs(

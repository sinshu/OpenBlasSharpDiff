...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="afp">
        /// [in,out] AFP is COMPLEX*16 array, dimension (N*(N+1)/2).
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_zppsvx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Zppsvx(

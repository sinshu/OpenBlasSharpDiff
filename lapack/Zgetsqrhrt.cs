...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="t">
        /// [out] T is COMPLEX*16 array, dimension (LDT,N)).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_zgetsqrhrt", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Zgetsqrhrt(

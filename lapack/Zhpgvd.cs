...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="bp">
        /// [in,out] BP is COMPLEX*16 array, dimension (N*(N+1)/2).
        /// On entry, the upper or lower triangle of the Hermitian matrix
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_zhpgvd", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Zhpgvd(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="t">
        /// [in] T is DOUBLE PRECISION array, dimension (MAX(5,TSIZE)).
        /// Part of the data structure to represent Q as returned by DGELQ.
        /// </param>
        /// <param name="tsize">
        /// [in] TSIZE is INTEGER.
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dgemlq", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dgemlq(

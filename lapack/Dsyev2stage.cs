...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dsyev_2stage", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dsyev2stage(

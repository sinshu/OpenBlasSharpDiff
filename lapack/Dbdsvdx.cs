...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="e">
        /// [in] E is DOUBLE PRECISION array, dimension (max(1,N-1)).
        ...
        /// </param>
        /// <param name="z">
        /// [out] Z is DOUBLE PRECISION array, dimension (2*N,K).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dbdsvdx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dbdsvdx(

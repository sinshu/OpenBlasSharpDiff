...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="e">
        /// [in,out] E is DOUBLE PRECISION array, dimension (max(1,N-1)).
        ...
        /// </param>
        /// <param name="z">
        /// [out] Z is DOUBLE PRECISION array, dimension (LDZ, max(1,M) ).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dstevx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dstevx(

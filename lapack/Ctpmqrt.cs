...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="v">
        /// [in] V is COMPLEX array, dimension (LDV,K).
        ...
        /// </param>
        /// <param name="a">
        /// [in,out] A is COMPLEX array, dimension.
        /// (LDA,N) if SIDE = &#39;L&#39; or
        /// (LDA,K) if SIDE = &#39;R&#39;
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_ctpmqrt", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Ctpmqrt(

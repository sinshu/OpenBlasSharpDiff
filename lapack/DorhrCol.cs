...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="t">
        /// [out] T is DOUBLE PRECISION array,.
        /// dimension (LDT, N)
        /// 
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dorhr_col", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo DorhrCol(

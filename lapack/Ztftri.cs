...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="a">
        /// [in,out] A is COMPLEX*16 array, dimension ( N*(N+1)/2 );.
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_ztftri", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Ztftri(

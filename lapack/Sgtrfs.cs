...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="dlf">
        /// [in] DLF is REAL array, dimension (N-1).
        ...
        /// </param>
        /// <param name="duf">
        /// [in] DUF is REAL array, dimension (N-1).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_sgtrfs", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Sgtrfs(

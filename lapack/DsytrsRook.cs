...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dsytrs_rook", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo DsytrsRook(

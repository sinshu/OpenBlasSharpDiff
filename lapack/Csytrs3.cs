...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="e">
        /// [in] E is COMPLEX array, dimension (N).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_csytrs_3", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Csytrs3(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="a">
        /// [in,out] A is DOUBLE PRECISION array, dimension (LDA,*).
        ...
        /// </param>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dsyswapr", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dsyswapr(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="x">
        /// [in] X is COMPLEX array, dimension (LDX,NRHS).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_ctprfs", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Ctprfs(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dgetsqrhrt", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dgetsqrhrt(

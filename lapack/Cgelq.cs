...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="t">
        /// [out] T is COMPLEX array, dimension (MAX(5,TSIZE)).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_cgelq", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Cgelq(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="a">
        /// [in] A is COMPLEX array, dimension ( N*(N+1)/2 );.
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_cpftrs", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Cpftrs(

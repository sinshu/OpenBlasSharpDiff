...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="tb">
        /// [out] TB is COMPLEX array, dimension (LTB).
        /// Details of factors computed by CSYTRF_AA_2STAGE.
        /// </param>
        /// <param name="ltb">
        /// [in] LTB is INTEGER.
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_csytrs_aa_2stage", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo CsytrsAa2stage(

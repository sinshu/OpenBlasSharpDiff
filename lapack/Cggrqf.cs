...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="taua">
        /// [out] TAUA is COMPLEX array, dimension (min(M,N)).
        ...
        /// </param>
        /// <param name="taub">
        /// [out] TAUB is COMPLEX array, dimension (min(P,N)).
        /// The scalar factors of the elementary reflectors which
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_cggrqf", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Cggrqf(

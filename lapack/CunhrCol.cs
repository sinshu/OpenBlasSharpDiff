...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="d">
        /// [out] D is COMPLEX array, dimension min(M,N).
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_cunhr_col", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo CunhrCol(

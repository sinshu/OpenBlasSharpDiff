...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dsbev_2stage", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dsbev2stage(

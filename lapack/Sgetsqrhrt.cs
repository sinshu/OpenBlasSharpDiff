...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="t">
        /// [out] T is REAL array, dimension (LDT,N)).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_sgetsqrhrt", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Sgetsqrhrt(

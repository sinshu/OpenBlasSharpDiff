...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="ef">
        /// [in,out] EF is DOUBLE PRECISION array, dimension (N-1).
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dptsvx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dptsvx(

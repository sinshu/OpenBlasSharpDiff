...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="bp">
        /// [in,out] BP is DOUBLE PRECISION array, dimension (N*(N+1)/2).
        /// On entry, the upper or lower triangle of the symmetric matrix
        ...
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dspgvx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Dspgvx(

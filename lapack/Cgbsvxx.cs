...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </param>
        /// <param name="afb">
        /// [in,out] AFB is COMPLEX array, dimension (LDAFB,N).
        ...
        /// ERR_BNDS_COMP.
        /// </returns>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_cgbsvxx", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo Cgbsvxx(

...
namespace OpenBlasSharp
{
    public static partial class Lapack
    {
        ...
        /// </para>
        /// </remarks>
        [DllImport(OpenBlas.LibraryName, EntryPoint = "LAPACKE_dsytrf_rook", CallingConvention = CallingConvention.Cdecl)]
        public static extern unsafe LapackInfo DsytrfRook(
